...
1. `feedback/metrics/` の最新集計(なければ先に `scripts/aggregate_feedback.py` を実行)
...
1. **レポート品質指標の確認**(設計書11章) — Useful Item Rate / Noise Rate / Action Conversion Rate / Source Compliance Rate。目標: useful↑ noise↓ action↑ compliance=100%
